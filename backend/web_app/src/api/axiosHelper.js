...
import { getJWTToken, getRefreshToken, removeJWTToken, removeRefreshToken, setJWTToken, setRefreshToken } from "./auth";
import { store } from "../redux/store";

const DEFAULT_ERROR_OBJECT = {
  detail: "Unexpected error occurred. Please try again.",
};
export const baseURL = "https://eisman-russo-inc-46749.botics.co/"
...
const useMainApi = (url, method = "get", formData = null, requestParams = {}, validateJsonResponse = true, timeout = 30000) => {
    ...
    main_api({
      ...
      .then((response) => {
        if (!unmounted) {
          ...
          if (!validateJsonResponse || (contentType && contentType.indexOf("application/json") !== -1)) {
