"""
Django settings for eisman_russo_inc_46749 project.
...
WSGI_APPLICATION = "eisman_russo_inc_46749.wsgi.application"
...
REST_FRAMEWORK = {
    "DEFAULT_SCHEMA_CLASS": "base.custom_auto_schema.CustomAutoSchema",
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "eisman_russo_inc_46749 API",
    "DESCRIPTION": "API documentation for eisman_russo_inc_46749 App",
    "VERSION": "v1",
}
